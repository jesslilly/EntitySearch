...
namespace EntitySearch.Demo.Web.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,OrderNumber,CustomerId,ProductId,Quantity")] Order order)
        {
            ...
            ViewBag.ProductId = new SelectList(db.Products, "ProductId", "Manufacturer", order.ProductId);
            return View(order);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,OrderNumber,CustomerId,ProductId,Quantity")] Order order)
        {
            if (ModelState.IsValid)
            {
